...
public class ConfigurationTest {
    ...
    public void testUDPPortNumberMustNotBeNull() {
        Configuration instance = new Configuration(null, 30, 50, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }

    @Test(expected = IllegalStateException.class)
    public void testUDPPortNumberMustNonNegative() {
        Configuration instance = new Configuration(-1, 30, 50, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }

    @Test(expected = IllegalStateException.class)
    public void testUDPTimeAnnouncementMustNotBeNull() {
        Configuration instance = new Configuration(80, null, 50, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }

    @Test(expected = IllegalStateException.class)
    public void testUDPTimeAnnouncementMustNonNegative() {
        Configuration instance = new Configuration(80, -1, 50, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }

    @Test(expected = IllegalStateException.class)
    public void testRefreshFileTimeMustNotBeNull() {
        Configuration instance = new Configuration(80, 30, null, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }

    @Test(expected = IllegalStateException.class)
    public void testRefreshFileTimeMustNonNegative() {
        Configuration instance = new Configuration(80, 30, -1, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }
    
    @Test(expected = IllegalStateException.class)
    public void testIgnoreFilesMustNotBeEmpty() {
        Configuration instance = new Configuration(80, 30, -1, "sharedTest", "downloadTest", true, true, empty, ignoreFilesStartingWith,ignoreFilesWithExtension);
    }
    
    @Test(expected = IllegalStateException.class)
    public void testIgnoreFilesStartingWithMustNotBeEmpty() {
        Configuration instance = new Configuration(80, 30, -1, "sharedTest", "downloadTest", true, true, ignoreFiles, empty,ignoreFilesWithExtension);
    }
    
    @Test(expected = IllegalStateException.class)
    public void testIgnoreFilesWithExtensionMustNotBeEmpty() {
        Configuration instance = new Configuration(80, 30, -1, "sharedTest", "downloadTest", true, true, ignoreFiles, ignoreFilesStartingWith,empty);
    }
